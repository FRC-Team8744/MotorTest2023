...
buttonY.onTrue(new VelocityMode(-1000.0, m_motorSub).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton buttonX = new JoystickButton(gamepad, 3);        
buttonX.onTrue(new VelocityMode(1000.0, m_motorSub).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton buttonB = new JoystickButton(gamepad, 2);        
buttonB.onTrue(new PositionMode(1.5, m_motorSub).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
